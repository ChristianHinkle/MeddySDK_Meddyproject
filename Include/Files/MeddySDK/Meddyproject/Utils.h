...
namespace MeddySDK
{
     ...
     */
    MEDDYSDK_MEDDYPROJECT_EXPORT ExpectedResult<MeddySDK::Meddyproject, Error_GetOuterDotMeddyprojectPath> GetOuterMeddyproject(boost::filesystem::path&& filesystemPath);
}
