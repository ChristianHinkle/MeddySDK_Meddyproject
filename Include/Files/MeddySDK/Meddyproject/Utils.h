...
namespace MeddySDK
{
     ...
     */
    MEDDYSDK_MEDDYPROJECT_EXPORT CppUtils::ExpectedResult<MeddySDK::Meddyproject, Error_GetOuterDotMeddyprojectPath> GetOuterMeddyproject(boost::filesystem::path&& filesystemPath);
}
